...
/**
 * Servlet implementation class PreEmployeeManagement
 */

@WebServlet(
		urlPatterns = {"/PreEmployeeManagement" }, 
		initParams = { 
...
public class PreEmployeeManagement extends HttpServlet {
	...
	protected void processRequest(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		String targetPage = "EmployeeManagement.jsp";
