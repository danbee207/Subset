...
/**
 * Servlet implementation class RevenueItem
 */

@WebServlet(
		urlPatterns = { "/RevenueValue" }, 
		initParams = { 
...
public class GetRevenueValue extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		switch(type){
		case 0: value = db.getRevenueByItemName(search);break;
		case 1:	String[] name = search.split(" "); value = db.getRevenueByBuyerName(name[0], name[1]);break;
		case 2: value = db.getRevenueByItemType(search);
