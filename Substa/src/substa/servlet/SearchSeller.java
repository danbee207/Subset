...
/**
 * Servlet implementation class SearchSeller
 */
@WebServlet(urlPatterns = { "/SearchSeller" }, initParams = {
...
public class SearchSeller extends HttpServlet {
	...
	private void processRequest(HttpServletRequest request, HttpServletResponse response) throws IOException {
		...
		ArrayList<AuctionDetailInfo> itemList = db.getAuctionInfoBySellerName(searchType[0], searchType[1]);
