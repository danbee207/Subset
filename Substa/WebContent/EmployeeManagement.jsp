	...
	<div class="container-fluid">
		...
		<div class="panel panel-default">
			...
			<div class="panel-body">
				...
				%>
				<button type="button" class="btn btn-default btn-lg" onclick="addEmployee();">
			...
			<div class="modal-content">
				...
				<div class="modal-body">
					...
					<form class="form-horizontal">
						...
						<div class="form-group">
							<label for="startDatelb" class="col-sm-4 control-label">Start
								Date</label>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<label for="levellb" class="col-sm-1 control-label">Last
								Level</label>
							<div class="col-sm-2">
								<input type="text" class="form-control" name="level" id="level">

							</div>
							<label for="hourlb" class="col-sm-4 control-label">HourlyRate</label>
							<div class="col-sm-2">
						...
						<div class="form-group">
							<div class="col-sm-offset-3 col-sm-10">
								...
								<button type="button" class="btn btn-primary"
									onclick="goToServlet(this);">Save Changes</button>
							</div>
				...
				<div class="modal-footer">
					...
					<button type="button" class="btn btn-primary" onclick="editEmployeeSave">Save changes</button>
					<%
						}
					%>
				</div>
